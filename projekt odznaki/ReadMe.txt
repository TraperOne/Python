	ZBIERAM ODZNAKI to autorski program, który zosta³ storzony dla mi³oœników gór - zdobywców Koron Górskich. Program s³u¿y do monitorowania na bierz¹co swoich osi¹gniêæ w zdobywaniu odznak na podstawie odbytych wycieczek w góry. Program ten uwzglêdnia wszystkie stopnie odznak Korony Pojedynczych Pasm Górskich. Odznakê najnizszego stopnia mozna Zdobyci, jeœli staniemy na przynjmniej jednym szczycie danego pasma górskiego. Natomiast odznakê najwy¿szego stopnia mo¿na zdobyæ jeœli staniemy na wszystkich szczytach z danego pasma.   

Pierwszym krokiem w programie jest za³o¿enie konta. Jak ju¿ konto zosta³o za³o¿one to wybieramy opcjê zaloguj. Przy rejestracji nale¿y podaæ imiê, nazwisko, oraz login i has³o do zalogowania siê. program posiada mo¿liwoœæ wycofania siê z rejestracji, jeœli siê nie decydujemy na za³o¿enie konta. Po za³o¿eniu konta program przekierowuje do zalogowania siê na za³o¿one konto. 

Po zalogowaniu siê do programu ukazuje nam siê menu. Mamy do wyboru: 
- "gdzie by³eœ",
- "twoje wycieczki", 
- "twoje odznaki",
- "usuñ wycieczkê",
...
Wybieraj¹c opcjê "twoje wycieczki", program wyœwietla historiê wprowadzonych wycieczek z podzia³em na poszczególne szczyty. Wyœwietlana jest tak¿e wysokoœæ n.p.m. ka¿dego szczytu. Program sortujê historiê wycieczek od najstarszej daty do najnowszej, czyli na górze mamy t¹ ostatni¹ odbyt¹ wycieczkê.
...
Algorytm zliczaj¹cy nie uwzglêdnia powtórnych wejœæ na ten sam szczyt, gdy¿ tylko jedno wejœcie na dany szczyt i tylko wszystkie szczyty z danego pasma zalicz¹ siê do zdobycia najwy¿szego stopnia odznaki Korony Pasma Górskiego.

Wybieraj¹c opcjê "usuñ wycieczkê", program wyœwietli listê wprowadzonych wycieczek i z tej listy mo¿emy dowoln¹ wycieczkê usun¹æ podajac datê wycieczki. Ta dodatkowa opcja mo¿e byæ przydatna W przypadku gdy siê pomylilismy przy wprowadzaniu wycieczki, a mimo to zosta³a zapisana.
